var runLevels = function (window) {
  ...
  window.opspark.runLevelInGame = function (game) {
    ...
    function createEnemy5(x, y){
      ...
      var redSquare = draw.bitmap("img/enemy5.png");
      redSquare.x = -37;
      redSquare.y = -25;
    ...
    function createReward(x, y){
      ...
      var blueSquare = draw.bitmap('img/CatTreat.png');
      blueSquare.x = -45;
      blueSquare.y = -45;
      ...
      function createReward2(x, y){
        var reward2 = game.createGameItem("enemy", 25);
        var blueSquare = draw.bitmap('img/BallOfYarn.png');
        blueSquare.x = -45;
        blueSquare.y = -45;
        reward2.addChild(blueSquare);
        reward2.x = x;
        reward2.y = y;
    ...
    function createMarker2(x, y){
      var marker2 = game.createGameItem("enemy", 25);
      var yellowSquare = draw.rect(50, 50, "yellow");
      yellowSquare.x = -25;
      yellowSquare.y = -25;
      marker2.addChild(yellowSquare);
      marker2.x = x;
      marker2.y = y;
      game.addGameItem(marker2);
      marker2.velocityX = -2;
    ...
    function createMarker3(x, y){
      var marker3 = game.createGameItem("enemy", 25);
      var yellowSquare = draw.rect(50, 50, "yellow");
      yellowSquare.x = -25;
      yellowSquare.y = -25;
      marker3.addChild(yellowSquare);
      marker3.x = x;
      marker3.y = y;
      game.addGameItem(marker3);
      marker3.velocityX = -2;
    ...
    function startLevel() {
      ...
      for(var i = 0; i < levelObjects.length; i++){
        ...
        if(element.type === 'marker2'){
          createMarker2(element.x, element.y);
        }
        
        if(element.type === 'marker3'){
    ...
    /*function startLevel2() {
      // TODO 13 goes below here
      var level2 = levelData[currentLevel];
      var levelObjects = level2.gameItems
      for(var i = 0; i < levelObjects.length; i++){
        var element = levelObjects[i];
        if(element.type === 'sawblade'){
          createSawBlade(element.x, element.y);
